...
BG = pygame.transform.scale(pygame.image.load("C:/Users/LENOVO/Downloads/snowimage.jpg"),(WIDTH, HEIGHT))
PLAYER_WIDTH =30
PLAYER_HEIGHT = 50
player_VILOCITY= 5
SNOW_WIDTH = 25
...
SNOW_FLAKE = pygame.image.load("C:/Users/LENOVO/Downloads/snowflake.snowglobe.PNG")
    ...
    while run:
        ...
        if hit:
            ...
            while gameover:
                ...
                final_time_text=FONT.render(f"YOUR TIME:{round(elapsed_time)}s",1,"white")
